...
contract PreArtixERC20 is Divine {
  ...
  constructor() Divine( "Pre ARTIX", "pARTIX", 18 ) {
  ...
  function _beforeTokenTransfer(address from_, address to_, uint256 amount_ ) internal override {
    require( (_balances[to_] > 0 || isApprovedSeller[from_] == true), "Account not approved to transfer pARTIX." );
  }
